...
import static mazeducks.Timed.dif;
...
public class TimedMaze extends JFrame{
    ...
    public TimedMaze(String str, int b){
        ...
        bg.setLocation((columns*panelSize)+50,25);
        bg.setSize(120,(rows*panelSize));
        ImageIcon imageIcon = new ImageIcon("/mazeducks/stopwatch.jpg"); // load the image to a imageIcon
                                        ...
                                        try
                                            {
                                               ...
                                               String query1 = "insert into timeboard values ( '" + username + "' , " + count+"," + hrs+ "," + mins + "," + 0 + ");";
