...
public class Leaderboard extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        time.setBounds(250, 130, 66, 28);

        difficulty.setFont(new java.awt.Font("Champagne & Limousines", 0, 24)); // NOI18N
        difficulty.setText("By Difficulty");
        ...
        difficulty.setBounds(417, 130, 110, 28);
        ...
        try
    {
        ...
        String query1 = "select * from leaderboard order by hrs,mins,secs, difficulty DESC;";
        ...
        try
    {
        Class.forName("com.mysql.cj.jdbc.Driver");
        Connection con = DriverManager.getConnection("jdbc:mysql://127.0.0.1:3306/mazegame?zeroDateTimeBehavior=convertToNull", "root", "1234");
        String query1 = "select * from leaderboard order by difficulty DESC, hrs, mins, secs;";
        Statement st=con.createStatement();
        ResultSet rs=st.executeQuery(query1);
        DefaultTableModel model=(DefaultTableModel)leaderboard_table.getModel(); 
        model.setRowCount(0);
